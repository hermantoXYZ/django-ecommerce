"""
Django settings for Qqzhu_Bag project.
...
SECRET_KEY = 'django-insecure-a-zczf42$-%or6fh(*49!h-u#9sx+kmf^yrnt7x_00_yg3to8%'
...
WSGI_APPLICATION = 'Qqzhu_Bag.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_ecommerce_bisdig',       # Nama database MySQL yang telah Anda buat
        'USER': 'root',   # Username MySQL Anda
        'PASSWORD': 'HukmiA02.',   # Password MySQL Anda
